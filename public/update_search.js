...
const headerSearch = `
  <div id="headerSearchBar" style="display:none;position:fixed;top:60px;left:0;right:0;background:var(--header-gradient);padding:16px 20px;z-index:49;box-shadow:0 2px 12px rgba(132,0,21,0.3);">
    <div style="max-width:600px;margin:0 auto;position:relative;display:flex;align-items:center;">
      <span class="material-symbols-outlined" style="position:absolute;left:16px;color:rgb(255, 255, 255);font-size:22px;pointer-events:none;">search</span>
      <input id="headerSearchInput" type="text" placeholder="Rechercher des alertes..." oninput="filtrerAlertesRecherche(this.value)" style="width:100%;height:48px;padding:0 50px 0 50px;background:rgba(236, 229, 229, 0.18);border:1.5px solid rgba(255,255,255,.25);border-radius:12px;font-size:14px;color:white;outline:none;transition:all .3s ease;font-family:'Plus Jakarta Sans',sans-serif;box-shadow:inset 0 1px 2px rgba(0,0,0,.15);" onfocus="this.style.background='rgba(255,255,255,.25)';this.style.borderColor='rgba(255,255,255,.5)';this.style.boxShadow='0 4px 20px rgba(0,0,0,.15)';" onblur="this.style.background='rgba(255,255,255,.18)';this.style.borderColor='rgba(255,255,255,.25)';this.style.boxShadow='none';"/>
